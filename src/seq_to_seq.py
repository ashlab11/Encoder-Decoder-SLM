...
from collators.data_collator_for_seq_to_seq import SelfSeq2SeqCollator
import os
from tqdm import tqdm

def seq_to_seq(output_dir: str, output_file_name: str):
...
if __name__ == "__main__":
    seq_to_seq(output_dir="models/base", output_file_name="seq_to_seq")
